...
export const ServiceHistoryCard: React.FC<ServiceHistoryCardProps> = ({
    ...
    const getStatusStyles = (status: string) => {
        switch (status) {
            ...
            default:
                return "text-[#475569] bg-gray-400/10 border-gray-400/20";
        }
    };
        ...
        >
            ...
            <div className="flex justify-between items-start mb-6">
                <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-2xl bg-[#F8F9FB] border border-[#E4E7EC] flex items-center justify-center group-hover:bg-theme-green/10 group-hover:border-theme-green/20 transition-all duration-500">
                        <Car className="w-5 h-5 text-[#475569] group-hover:text-theme-green transition-colors" />
                    </div>
                    <div>
            ...
            <div className="flex items-center justify-between pt-5 border-t border-[#E4E7EC]">
                <div className="flex flex-col">
                    <span className="text-[7px] font-black text-[#94A3B8] uppercase tracking-widest mb-0.5">Booking Ref</span>
                    <span className="text-[9px] font-bold text-[#475569] tracking-widest uppercase">{bookingId}</span>
                </div>
