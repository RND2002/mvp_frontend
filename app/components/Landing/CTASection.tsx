    ...
    return (
        <section className="py-32 bg-background relative overflow-hidden">
            <div className="container mx-auto px-4 md:px-6">
                <div className="relative rounded-[48px] overflow-hidden border border-border-default bg-bg-secondary px-6 py-24 text-center">
                    {/* Background Accents */}
                    ...
                    <div className="relative z-10 max-w-3xl mx-auto space-y-10 animate-in fade-in zoom-in duration-1000">
                        <div className="space-y-4">
                            <h2 className="text-5xl md:text-7xl font-black text-text-primary tracking-tighter leading-none uppercase">
                                ELEVATE YOUR <br />
