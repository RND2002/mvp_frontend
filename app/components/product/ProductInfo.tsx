    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            <div className="text-sm text-white">
                Home {">"} category {">"} <span className="text-primaryText font-medium">{data.title}</span>
            </div>
            ...
            <div>
                ...
                <div className="flex items-center gap-2 mt-2">
                    <span className="text-sm text-white">Net Qty: {data.netQty}</span>
            ...
            <div className="flex items-center gap-3">
                <span className="text-3xl font-bold text-primaryText">₹{data.price}</span>
                <span className="text-partner-button line-through text-lg">MRP ₹{data.mrp}</span>
                <span className="text-xs text-white">(Incl. of all taxes)</span>
            </div>
                ...
                <div className="space-y-4">
                    {data.highlights.map((item, idx) => (
                        <div key={idx} className="grid grid-cols-3 gap-4 text-sm">
                            <span className="text-white col-span-1">{item.label}</span>
